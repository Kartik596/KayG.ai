...
st.set_page_config(
    page_title="Market Intelligent Data Tool",
    layout="wide",
...
st.markdown("""
    ...
    /* Only style the Brainwave Recap button via the anchor trick */
    #ai-recap-btn + div > button {
        background: #177B5F !important;
        color: #fff !important;
        ...
        box-shadow: 0 1px 8px rgba(30,168,180,0.10);
        margin-top: 8px !important;
        opacity: 1 !important;
        display: inline-block !important;
    }
    #ai-recap-btn + div > button:hover {
        background: #12977C !important;
        color: #fff !important;
        opacity: 1 !important;
    }
    </style>
...
# Spinner text only (do not style button!), and button via anchor trick
st.markdown("""
    <style>
    .stSpinner > div > div {
    ...
    /* Only style the Button after the anchor */
    #ai-recap-btn + div > button {
        background: #177B5F !important;
        color: #fff !important;
        font-size: 17px !important;
